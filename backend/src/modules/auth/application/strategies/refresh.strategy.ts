...
export class RefreshTokenStrategy extends PassportStrategy(Strategy, 'jwt-refresh-token') {
    constructor(
        ...
        super({
            ...
            secretOrKey: configService.get<JwtConfigurationInterface['jwt']>('jwt').refreshSecret,
    ...
    async validate(request: Request, payload: ValidateJwtStrategyResult) {
        ...
        return this.usersService.getUserByIdAndRefreshToken(refreshToken, payload.sub)
    }
}